...
const GuidedSearch = () => {
  ...
  return (
    <main className="flex flex-col pb-36 ">
      {currentStep === 1 && (
        <section className="flex flex-col gap-8 items-center pt-20 mb-12 text-skin-base">
          ...
          <FilterSearch
            ...
            customCssClasses={{
              filterSearchContainer:
                "border-skin-base flex justify-center text-skin-muted",
              inputElement:
                "rounded-full px-8 py-4 border-zinc-900 text-base placeholder:text-neutral-500 w-96 h-full text-skin-muted",
              option: "py-2 px-4",
      ...
      {currentStep === 2 && (
        <section className="flex flex-col gap-8 items-center pt-20 text-skin-base">
          <h2 className="text-2xl font-bold">
