...
const EventStandard = ({ result }: CardProps<any>) => {
  ...
  return (
    <article
      className=" text-skin-muted flex gap-2 md:gap-8 cards justify-start w-full items-start md:items-center flex-col md:flex-row"
    ...
    >
      ...
      <header className="flex flex-col text-skin-base">
      ...
      <footer
        className="w-full md:w-auto flex flex-row md:flex-col items-center justify-center gap-2 md:pt-4 pb-2 md:ml-auto md:mr-4"
