...
const ProfessionalStandard = ({ result }: CardProps<any>) => {
  ...
  return (
    <article className="text-skin-muted border rounded-lg flex justify-between  pr-4">
      ...
      <section className="px-2 space-y-1 ml-4 flex-1 mt-4">
        <header className="flex justify-between text-skin-base">
          <a
            id={`location-${id}`}
            target="_blank"
            href={slug}
          ...
          >
            <span
              className="bg-black text-skin-banner text-center w-6 h-6 rounded-full flex items-center justify-center text-sm"
