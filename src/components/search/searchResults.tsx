            ...
            {universalResultsLength >= 1 ? (
              <article className="centered-container my-12">
                ...
                <footer aria-label="Geolocation">
                  <Geolocation
                    customCssClasses={{
                      geolocationContainer: "text-lg items-center mt-8",
                      button: "text-skin-base",
                    }}
                  />
                </footer>
              </article>
            ) : (
              <article className="centered-container my-12">No Results</article>
            )}
          </>
        ) : (
          <>
            {resultsCount > 0 ? (
              <>
                {pageType === "map" ? (
                  <section className="w-full flex md:h-[950px] mb-16">
                    <article className="w-full md:w-2/5 h-full">
                      <SpellCheck />
                      <div className="w-full h-auto overflow-scroll relative">
                        <header className="results-header">
                          <aside className="flex justify-between w-full md:pr-8 items-center  text-skin-base">
                            <ResultsCount />
                            {facetsCount >= 1 && (
                              <div
                                className=" hover:cursor-pointer font-semibold text-neutral mb-4 py-2 md:mr-2.5"
                          ...
                          {showFacets && (
                            <div className="w-full block absolute inset-0 bg-skin-banner h-full md:h-[95vh] px-4 ">
                              <IoClose
                              ...
                              <Facets
                                customCssClasses={{
                                  facetsContainer:
                                    "mr-10 !text-lg  text-skin-base",
                                }}
                                searchOnChange={true}
                              />
                              <div className="flex flex-row gap-4 mb-8 items-center mt-4 text-sm">
                                <div
                                  className="px-4 py-1 border bg-skin-base  text-skin-banner hover:cursor-pointer "
                                  onClick={(e) => setShowFacets(!showFacets)}
                                >
                                  Apply
                                </div>
                                <div
                                  className="hover:cursor-pointer px-4 py-1 border border-skin-base w-fit text-skin-base"
                                  onClick={(e) => setShowFacets(false)}
                                >
                                  Cancel
                                </div>
                      ...
                      <nav aria-label="Pagination" className="text-lg">
                        <Pagination
                          customCssClasses={{
                            ...
                            label: "bg-skin-muted",
                            selectedLabel: "bg-skin-base text-skin-banner",
                          }}
                        />
                      </nav>
                      <footer aria-label="Geolocation">
                        <Geolocation
                          customCssClasses={{
                            geolocationContainer: "text-lg text-skin-base",
                          }}
                        />
                      </footer>
                    </article>
                  ...
                  <section className="w-full flex max-w-full md:px-14 mx-auto">
                    <aside className="hidden md:block w-[200px]">
                      {facetsCount >= 1 && (
                        <Facets
                          customCssClasses={{
                            facetsContainer: "py-4 w-full text-skin-base",
                            titleLabel: "text-lg",
                          }}
                        />
                      )}
                    ...
                    <div className="relative md:px-14 md:max-w-screen-2xl w-full !mx-auto md:!pr-40">
                      <header className="results-header ">
                        ...
                        />
                        <article className="hidden md:flex justify-between w-full items-center text-skin-base">
                          <ResultsCount />
                        ...
                        <article className="md:hidden flex items-center justify-between font-semibold text-neutral  md:mr-2.5">
                          <ResultsCount />
                          <div
                        ...
                        {showFacets && (
                          <div className="h-full w-full z-40  absolute inset-0 bg-skin-banner px-4">
                            <IoClose
                              onClick={(e) => setShowFacets(false)}
                      ...
                      <footer aria-label="Geolocation">
                        <Geolocation
                          customCssClasses={{
                            geolocationContainer: "text-lg items-center",
                            button: "text-skin-base",
                          }}
                        />
                      </footer>
