...
const ProductAndHelpArticlesHero = ({
  ...
  return (
    <section
      className={`lg:relative ${isProduct ? `bg-gray-50` : `bg-skin-banner`}`}
    >
        ...
        <header className="lg:relative z-10 lg:pt-14 lg:w-full lg:max-w-2xl">
          {!isProduct && (
            <svg
              ...
              aria-hidden="true"
              className="lg:absolute inset-y-0 right-8 hidden h-full w-80 translate-x-1/2 transform fill-skin-banner lg:block"
            >
