...
const CarouselCard = ({
  ...
  return (
    <article
      className="bg-skin-banner border flex flex-col md:ml-8 lg:pb-6 pb-4 md:pb-0 md:mx-2 mx-8"
    ...
    >
      ...
      <section className="px-4 space-y-2 md:space-y-4 mt-4">
        <h3 className="text-skin-base line-clamp-2 text-lg font-bold">
          {isLocationType ? (
...
const Carousel = ({
  ...
  return (
    <section className="bg-primary-bg flex flex-col gap-4 lg:gap-8">
      <header>
        <h2
          className="text-2xl md:text-3xl font-medium mx-auto text-center text-skin-base"
          role="heading"
          aria-level={2}
        >
          {title}
