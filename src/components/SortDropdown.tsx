      ...
      {resultsCount && (
        <>
          ...
          <section className="hidden md:block relative text-sm ml-auto">
            ...
            >
              <MenuButton
                className="inline-flex w-full md:w-56 justify-between gap-x-1.5 rounded-md bg-skin-banner px-3 py-2 text-sm text-skin-base shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                aria-expanded="false"
              >
                <div
                ...
                <ChevronDownIcon
                  aria-hidden="true"
                  className="-mr-1 h-5 w-5 text-skin-base"
                />
              </MenuButton>

              <MenuItems
                transition
                className="absolute right-0 z-10 w-full md:w-56 origin-top-right rounded-md bg-skin-banner shadow-lg ring-1 ring-black ring-opacity-5 transition-all ease-out duration-200"
              >
                <ul className="py-1">
                  {sortOptions.map((s) => (
                    <MenuItem
                      ...
                      {({ active }) => (
                        <li
                          className={`md:text-base text-xs flex h-6 md:h-10 w-full md:w-56 items-center px-2 ${
                            active ? "bg-gray-200" : "bg-skin-banner"
